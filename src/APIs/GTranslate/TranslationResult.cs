...
namespace Fergun.APIs.GTranslate
{
    ...
    public class TranslationResult
    {
        ...
        /// </summary>
        public IReadOnlyList<AlternativeTranslation> AlternativeTranslations { get; } = Array.Empty<AlternativeTranslation>();

        /// <summary>
        /// Gets the language detections.
        /// </summary>
        public IReadOnlyList<LanguageDetection> LanguageDetections { get; } = Array.Empty<LanguageDetection>();
    }
