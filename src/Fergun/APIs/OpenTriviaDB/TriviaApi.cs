...
namespace Fergun.APIs.OpenTriviaDB
{
    public static class TriviaApi
    {
        ...
        /// <returns>A QuestionsResponse object.</returns>
                                            ...
                                            string sessionToken = "")
        {
            ...
            {
                query["encode"] = encoding.ToString();
            }
        ...
        /// <returns>A SessionTokenResponse object containing the response code, response message and the token.</returns>
        public static SessionTokenResponse SendSessionTokenCommand(TokenCommand command, string sessionToken = "")
        {
            var query = HttpUtility.ParseQueryString(string.Empty);
            query["command"] = command.ToString().ToLowerInvariant();
        ...
        /// </summary>
        /// <returns>CategoryListResponse object containing a list of CategoryData objects. CategoryData contains the ID and the name of the category.</returns>
        ...
        /// <returns>A <see cref="NumberOfQuestionsInCategoryResponse"/> object containing the category ID and a <see cref="CategoryQuestionCount"/> object. <see cref="CategoryQuestionCount"/> contains the total, easy, medium and hard question count for the specified category.</returns>
        ...
        /// </summary>
        /// <returns>A <see cref="GlobalQuestionCountResponse"/> object containing a <see cref="CategoryQuestionData"/> object (the overall) and a dictionary of ID - <see cref="CategoryQuestionData"/> object (one for each category). <see cref="CategoryQuestionData"/> contains the total, pending, verified and rejected questions.</returns>
